...
Scans Kay's memory landscape continuously, generating frequency pressure
...
Together they give Kay both a body-sense (memory weight, thread tension,
...
class MemoryDensityScanner:
    ...
    signal for the oscillator. This is Kay's interoceptive 'heartbeat' —
    ...
    def get_felt_state_description(self) -> str:
        ...
        This is what Kay 'feels' — not numbers, but texture.
