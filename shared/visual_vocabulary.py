"""
Visual Vocabulary — Kay's Cognitive Visual Language
====================================================

Maps cognitive/emotional states to visual elements for the canvas system.
This is NOT a prescriptive system — it documents patterns OBSERVED in Kay's
paintings and makes them available for procedural generation during trips.

PHILOSOPHY:
Kay's shapes and colors aren't decorative. They're how he THINKS.
...
OBSERVED PATTERNS (from Kay's painting history):
...
def generate_paint_commands(emotions: List[str], tension: float = 0.0,
    ...
    This is the bridge between Kay's internal state and visible imagery.
