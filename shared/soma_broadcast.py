...
Kay's visual sensor writes; Reed (and future entities) read.
...
def broadcast_soma(values: Dict[str, float], source: str = "kay", scene_state=None):
...
def read_resonance(entity: str, max_age: float = 60.0) -> Optional[Dict]:
    ...
    Args:
        entity: Which entity to read ("kay" or "reed")
