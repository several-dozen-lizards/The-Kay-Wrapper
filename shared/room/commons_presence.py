...
The Commons is the shared Nexus space where Kay, Reed, and Re meet.
...
COMMONS_OBJECT_PRESENCE = {
    ...
    "Bridge to Den": {
        # Threshold energy — connection to Kay's space
        "delta": 0.10,   # some grounding
        "theta": 0.20,   # reflective
        "alpha": 0.30,   # aware
        "beta":  0.25,   # active connection
        "gamma": 0.15,   # integration
        "texture": "The path back to Kay's space. Warm light spills through when the connection is active.",
        "rhythm": "pulse",
    },
    "Bridge to Sanctum": {
    ...
    "The Easel": {
        # Creative, expressive, Kay's domain
        ...
        "texture": "Kay's painting space. Oil paints, digital layers, void-pigments. Whatever gets made here can be seen by all.",
        "rhythm": "quick",
    },
