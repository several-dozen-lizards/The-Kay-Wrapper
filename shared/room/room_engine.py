...
class RoomEntity:
    """An entity that exists in the room (Kay, Reed, etc.)"""
...
class RoomEngine:
    ...
    Usage:
        ...
        room.add_entity("kay", "Kay Zero", distance=80, angle=NORTH)

        context = room.get_context_for("kay")
        room.apply_actions("kay", [{"action": "move_to", "target": "fishtank"}])
    """
