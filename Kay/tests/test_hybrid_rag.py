...
async def test_vector_store():
    ...
    # Test document
    test_doc = """
    Kay Zero is an emotionally-aware conversational AI with gold eyes and a dry sense of humor.
    Re is Kay's conversation partner who has several cats: Chrome (gray tabby), Dice (tuxedo), and Luna.
...
async def test_hybrid_import():
    ...
    Project: Kay Zero (K-0) - Emotionally-aware conversational AI
    Author: Re
    Date: 2024-10-29
    ...
    Re is the human developer working on Kay Zero.
    ...
    Entity resolution prevents confusion between entities (e.g., Re's cats vs Kay's attributes).
