"""
Scratchpad Engine - Kay's Quick Note System

Provides Kay with the ability to jot down questions, flags, thoughts,
...
class ScratchpadEngine:
    ...
    def add_item(self, content: str, item_type: str = "note") -> dict:
        ...
        item = {
            ...
            "resolution_note": None,  # Kay's conclusion
    ...
    def get_review_display(self) -> str:
        ...
        # Sort by timestamp (oldest first) so Kay sees what's been sitting longest
