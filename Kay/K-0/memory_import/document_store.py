...
def retrieve_document_command(doc_identifier: str) -> Dict[str, Any]:
    ...
    Can be called from Kay's conversation processing.
...
if __name__ == "__main__":
    ...
    There was a knife fight. Gwyn ap Nudd intervened. The boy lived, but Kay's mother was
