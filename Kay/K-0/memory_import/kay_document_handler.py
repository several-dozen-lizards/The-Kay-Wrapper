"""
Document Access Handler for Kay Zero
Processes Kay's document requests in conversation
"""
...
class KayDocumentHandler:
    ...
    Integrates with kay_ui.py to allow Kay to:
    ...
    def inject_document_access_prompt(self) -> str:
        """
        Generate prompt section for Kay's system prompt.
...
# Integration helper for kay_ui.py
