...
Replaces external emotional parser with Kay's own reading and compression
...
class KayReader:
    ...
    def read_document(self, document_text: str, filename: str) -> Dict:
        ...
        Returns:
            Dict with:
            - shape: Kay's sense of what this document is
        ...
        # Build prompt for Kay to read document
...

{
  ...
  "sections": [
    ...
    def _build_reading_prompt(self, document_text: str, filename: str) -> str:
        """Build prompt for Kay to read specific document"""
