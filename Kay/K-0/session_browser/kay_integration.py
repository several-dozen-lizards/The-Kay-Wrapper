"""
Kay UI Integration Adapter
Helper functions for integrating Session Browser into existing Kay UI
"""
...
class SessionBrowserIntegration:
    """
    Integration adapter for adding Session Browser to Kay UI
