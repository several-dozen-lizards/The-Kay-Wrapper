...
def test_session_memory():
    ...
    session_memory.add_turn(
        ...
        kay_response="There's Gimpy, Bob, Fork, and Zebra",
        emotional_state={
            "primary": "helpfulness",
            "intensity": 0.6,
            "pressure": 0.2,
    ...
    session_memory.add_turn(
        ...
        kay_response="Green - you told me that in turn 1",
        emotional_state={
            "primary": "confidence",
            "intensity": 0.9,
            "pressure": 0.1,
    ...
    turn3_response_correct = "green" in turns[2]['kay_response'].lower()
...
def test_session_continuity(session_memory):
    ...
    for i in range(4, 14):
        session_memory.add_turn(
            ...
            kay_response=f"Turn {i} Kay response",
            emotional_state={
                "primary": "neutral",
                "intensity": 0.5,
                "pressure": 0.1,
