...
class ConversationBuffer:
    ...
    def add_turn(self, user_input: str, kay_response: str, turn_number: int):
...
class SimplifiedMemoryEngine:
    ...
    def store_turn(self, user_input: str, kay_response: str):
        """
        Store a conversation turn.
        Extracts facts from user input and Kay's response.
        """
        self.current_turn += 1

        # 1. Store full turn in conversation buffer
        self.conversation.add_turn(user_input, kay_response, self.current_turn)
        ...
        # 3. Extract and store facts from Kay's response
        kay_facts = self.extract_facts(kay_response, "Kay")
...
def test_simple_memory():
    ...
    mem.store_turn(
        ...
        kay_response="Nice! Green eyes are beautiful"
    )
    ...
    mem.store_turn(
        ...
        kay_response="Coffee is great in the morning"
    )
    ...
    mem.store_turn(
        ...
        kay_response="Saga is a wonderful name for a dog"
    )
