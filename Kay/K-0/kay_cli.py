"""
Kay Zero CLI Mode - Full Engine Stack, No GUI
...
# === Engine Imports (same as kay_ui.py) ===
...
class KayCLI:
    ...
    def _init_engines(self):
        """Initialize all engines (same as kay_ui.py)."""
        # Core state
    ...
    def chat(self, user_input: str, conversational_mode: bool = False) -> dict:
        """
        Process a message and return Kay's response.
    ...
    def run_interactive(self):
        ...
        print("\n" + "="*60)
        print("KAY ZERO CLI - Full Engine Mode")
    ...
    def _run_warmup_phase(self):
        """Run Kay's warmup phase - private reconstruction time."""
        print("\n" + "="*60)
...
def main():
    parser = argparse.ArgumentParser(description="Kay Zero CLI - Full Engine Mode")
