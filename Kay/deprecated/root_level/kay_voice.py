"""
Voice mode for Kay Zero
Uses existing chat_loop from kay_ui.py with voice I/O
"""
...
def main():
    """Run Kay Zero in voice-only mode"""
    print("="*60)
    print("KAY ZERO - VOICE MODE")
    print("="*60)
    print("\nInitializing Kay Zero...")
    
    # Initialize Kay Zero (creates its own window)
    ...
    try:
        while True:
            ...
            # PROCESS through Kay's existing chat_loop
            try:
