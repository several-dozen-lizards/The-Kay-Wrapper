...
"""
Voice Engine for Kay Zero - Continuous Conversational Voice Mode
...
6. Kay's response streams sentence-by-sentence (with emotional context)
...
class VoiceEngine:
    """
    Continuous conversational voice engine for Kay Zero.
    ...
    def __init__(
        ...
        # cutting off Kay's responses after ~200ms. Set to True to re-enable.
