"""
Integration Guide: Wiring Web Tools into Kay's LLM Integration

This shows how to integrate the web scraping tools with Kay's existing
...
WHAT HAPPENS:
- Kay's LLM decides to use web_search("AI safety research")
- Tool handler executes the real web scraping
- Results get fed back to Kay's LLM
