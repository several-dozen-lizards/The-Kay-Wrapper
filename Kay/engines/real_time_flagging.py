"""
Real-Time Flagging
Allows Kay to mark moments as important during conversation
"""
...
class FlaggingSystem:
    """
    Handles Kay's real-time flagging of important moments
    """
    ...
    def check_for_flag(self, kay_response: str) -> Optional[Dict]:
        """
        Check if Kay is flagging current turn
    ...
    def _extract_flag_reason(self, text: str, trigger: str) -> str:
        """Extract why Kay flagged this moment"""
