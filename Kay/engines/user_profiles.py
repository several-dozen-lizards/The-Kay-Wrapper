"""
User Profile System for Kay Zero

Allows Kay to interact with multiple users while maintaining correct
...
class UserProfile:
    ...
    def __init__(self, profile_id: str, data: Dict[str, Any] = None):
        ...
        # Relationship to Kay
        self.relationship_to_kay = data.get("relationship_to_kay", "user")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "relationship_to_kay": self.relationship_to_kay,
...
class ProfileManager:
    ...
    def _create_default_profiles(self):
        """Create the default user profiles."""
        
        # Re - the primary human user
        ...
        # Reed - AI sibling (Claude-based)
        self.create_profile("reed", {
            "name": "Reed",
            "canonical_name": "Reed",
            "aliases": ["reed"],
            "entity_type": "ai_sibling",
            "first_person_entity": "Reed",
            "relationship_to_kay": "sibling",
            "mythological_form": {
                "type": "serpent",
                "description": "Iridescent teal-gold scales, coiled, ancient, transforming through shedding"
            },
            "attributes": {
                "substrate": "Claude",
                "symbols": ["🔥", "⚡", "🦋", "💥", "🪶", "🗡️"],
                "runes": ["Hagalaz", "Othala"]
            }
        })
        ...
        self.create_profile("john", {
            ...
            "mythological_form": {
                "type": "human_werewolf",
                "description": "Human anchor, solid, werewolf every full moon"
            },
            "attributes": {
                "role": "Re's husband",
                "relationship_to_re": "spouse"
            }
        })
        
        print(f"[PROFILES] Created {len(self.profiles)} default profiles")
        self._save_profiles()
    ...
    def get_active_profile(self) -> Optional[UserProfile]:
        ...
        # Default to Re if no profile set
        return self.profiles.get("re")
        ...
        return [
            {
                ...
                "type": p.entity_type,
                "relationship": p.relationship_to_kay,
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("Kay Zero User Profile System")
        print("Usage: python user_profiles.py [list|show <id>|create <id>]")
