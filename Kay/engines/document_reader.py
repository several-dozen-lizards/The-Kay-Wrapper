...
2. DocumentReader: Chunks large documents for Kay to navigate sequentially
...
class DocumentReader:
    """
    Manages chunked reading of large documents for Kay's navigation.
    ...
    def get_current_chunk(self) -> Optional[Dict]:
        ...
        Returns:
            Dict with:
                ...
                - previous_comment: Kay's previous comment on this chunk (if any)
    ...
    def add_comment(self, chunk_index: int, comment: str):
        """
        Store Kay's comment about a specific chunk.

        Args:
            chunk_index: Chunk index (0-indexed)
            comment: Kay's comment about the chunk
        """
    ...
    def get_comment(self, chunk_index: int) -> str:
        """
        Retrieve Kay's previous comment about a chunk.
