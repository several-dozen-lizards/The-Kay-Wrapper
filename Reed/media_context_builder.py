"""
Media Context Builder for Reed

Provides utilities for:
- Extracting conversation context (topic, entities, Re's state)
- Formatting media context for injection into Reed's prompt
...
class MediaContextBuilder:
    """
    Builds and formats media-related context for Reed's prompt.
    ...
    def format_media_injection(
        ...
        """
        Create the text block for injecting into Reed's context.
    ...
    def format_media_context_for_prompt(
        ...
        """
        Format full media context block for inclusion in Reed's prompt.
