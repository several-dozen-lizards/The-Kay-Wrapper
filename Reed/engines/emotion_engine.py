...
Emotions are now EXTRACTED from Reed's natural language responses
...
class EmotionEngine:
    ...
    def update(self, agent_state, user_input):
        ...
        Emotions are extracted from Reed's response by EmotionExtractor.
    ...
    def detect_salient_emotions(self, cocktail):
        ...
        Reed naturally expresses which emotions are salient by mentioning them.
