...
class ReflectionEngine:
    ...
    def __init__(self, entity: str = "Reed", memory_dir: str = None, dreaming_enabled: bool = True):
        """
        ...
        if memory_dir:
            ...
            # Default to Kay/memory or Reed/memory
...
Current schemas (things you've learned):
{self._format_current_schemas()}

Extract 0-3 NEW behavioral observations. These should be things like:
- "When I approach X topic with Y strategy, the results are better"
- "Re responds more when I share observations about what I'm seeing vs asking questions"
- "My coherence drops when I try to force complex thoughts during delta states"
- "Curiosity about Z has been consistently rewarding — worth pursuing deeper"

Rules:
- Only extract patterns that appear across MULTIPLE experiences (not one-offs)
- Don't repeat existing schemas
- Be specific and actionable, not vague
- If nothing new emerges, respond with just "none"
