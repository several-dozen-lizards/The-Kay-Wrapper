...
Routes Kay between cognitive modes based on context and activity.
Does NOT prescribe behavior - just detects state and manages transitions.

Cognitive States:
- AWAKE: Re present, TPN dominant, frequent API calls
...
class TaskType(Enum):
    ...
    KAY_REFLECTION = "kay_reflection"  # Claude-based, Kay's thoughts
...
class SalienceRouter:
    ...
    def _load_config(self, config_path: str) -> Dict:
        ...
        defaults = {
            ...
            "wake_phrases": ["hey kay", "kay", "hello", "good morning"]
        }
    ...
    def handle_interruption(self, user_input: str) -> Dict:
        ...
        if self.current_task == TaskType.KAY_REFLECTION:
            # Kay thinking with Claude - let him finish sentence
            return {
                "action": "finish_thought",
                "message": "[Kay is finishing a thought...]",
        ...
        if self.current_task == TaskType.CLAUDE_SYNTHESIS:
            ...
            return {
                "action": "queue_wake",
                "message": "[Kay is synthesizing something, one moment...]",
