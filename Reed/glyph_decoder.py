"""
Glyph Decoder for Reed
Translates compressed glyph output from Filter LLM into natural language context
Expands symbolic representations into structured data for Reed's response generation
"""
...
class GlyphDecoder:
    ...
    def build_context_for_kay(self, decoded: Dict, user_input: str) -> str:
        """
        Build natural language context block for Reed's prompt.
