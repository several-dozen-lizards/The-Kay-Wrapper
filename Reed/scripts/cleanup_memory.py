"""
Memory Cleanup Script for Reed
...
def cleanup_memory(keep_identity: bool = False, dry_run: bool = False):
    """
    Clean Reed's memory with backup.

    Args:
        keep_identity: If True, preserve identity facts (Re and Reed's core info)
