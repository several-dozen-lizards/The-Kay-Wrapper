...
class GitHubService:
    """
    Read-only GitHub API client for Reed.
    ...
    def format_for_kay(self, content: str, source: str, max_chars: int = 5000) -> str:
        """
        Format content for inclusion in Reed's context.
        ...
        Returns:
            Formatted string for Reed's context
        """
...
def handle_github_command(command: str) -> str:
    """
    Handle /github commands from Reed's interface.
