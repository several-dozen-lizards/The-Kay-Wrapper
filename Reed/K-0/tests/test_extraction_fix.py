...
Tests that Reed's conversational references don't create false Kay-facts.
"""
...
def test_extraction_conversational_references():
    ...
    reed_response = "Your cats - Dice, Chrome, and Luna - sound wonderful!"

    # Extract facts
    extracted_facts = memory._extract_facts(user_input, reed_response)
    ...
    reed_response_2 = "My eyes are gold."

    extracted_facts_2 = memory._extract_facts(user_input_2, reed_response_2)
    ...
    reed_response_3 = "Yeah, my cats - Dice and Chrome - are great!"

    extracted_facts_3 = memory._extract_facts(user_input_3, reed_response_3)
