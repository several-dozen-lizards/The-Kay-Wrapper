...
def extract_reed_response(output, turn_number):
    """Extract Reed's response for a specific turn."""
    lines = output.split('\n')
    responses = []
    in_response = False
...
# Extract Reed's responses
response_1 = extract_reed_response(stdout, 1)
response_2 = extract_reed_response(stdout, 2)
