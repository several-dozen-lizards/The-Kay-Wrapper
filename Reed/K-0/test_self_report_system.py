...
def test_emotion_extractor():
    ...
    # Simulate Reed's response with emotional self-report
    reed_response = "I can feel the curiosity sitting at 0.68 right now, tracking it closely."

    # Extract emotions
    extracted = extractor.extract_emotions(reed_response)
...
def test_emotion_persistence():
    ...
    # Turn 1: Extract emotions from Reed's response
