...
ARCHITECTURE (v2 - Contextual Relational Reading):
  ...
  Phase 3: Integrated relational synthesis (what changed in Reed's understanding)
...
class ActiveDocumentReader:
    ...
    - Relational synthesis: What changed in Reed's understanding of Re
    """
...
Be direct and concise. Focus on UNDERSTANDING, not just summarizing."""
    ...
    # RELATIONAL SYNTHESIS PROMPT: What changed in Reed's understanding
...
Be yourself - direct, thoughtful. This was something Re wanted to share with YOU specifically."""
    ...
    def generate_pre_read_thoughts(self, filename: str, context: Dict) -> str:
        """
        PHASE 1: Generate Reed's pre-read thinking about why Re shared this.
        ...
        Returns:
            Reed's pre-read thoughts as string
        """
...
Format with markdown headers as shown in the prompt."""
    ...
    def _parse_chunk_analysis(self, response: str) -> Dict:
        """Parse Reed's contextual chunk analysis into structured data."""
        analysis = {
            'content_summary': '',
            'connection_to_re': '',
            'entities': [],
    ...
    def synthesize_document(self,
        ...
        Args:
            ...
            pre_read_thoughts: Reed's pre-read hypothesis
...
Format with markdown headers as shown in the prompt."""
    ...
    def read_document_streaming(self,
        ...
        Args:
            ...
            pre_read_thoughts: Reed's pre-read hypothesis about why Re shared this
        ...
        for i, chunk in enumerate(chunks, 1):
            ...
            # Format Reed's CONTEXTUAL analysis for display
...
def import_document_actively(
    ...
    3. RELATIONAL SYNTHESIS: What changed in Reed's understanding of Re
    ...
    # This prevents memory explosion while preserving Reed's reading journey
    # =========================================================================
    ...
    try:
        ...
        reading_experience_memory = {
            ...
            # Core content - Reed's journey through the document
    ...
    try:
        sharing_event_memory = {
            ...
            # Why this matters (from Reed's pre-read thoughts)
            'pre_read_thoughts': pre_read_thoughts,
    ...
    try:
        ...
        # Reed's relational understanding - WHY Re shared this, WHAT changed
        ...
        memories_created += 1
        log(f"[STORAGE] Created shared_understanding_moment memory\n")
...
def get_recent_imports(memory_engine, hours: int = 24) -> List[Dict]:
    """
    Get documents imported in the last N hours.

    Useful for answering "what did we just import?" questions.
    ...
    Returns:
        List of import completion events with document info
    """
...
def get_document_provenance(memory_engine, query: str) -> Optional[Dict]:
    ...
    Returns:
        Dict with document name, section, and Reed's analysis, or None
    """
...
def get_session_import_summary(memory_engine, session_id: str = None) -> Dict:
    ...
    Returns:
        Dict with session reading summary:
        {
            ...
            'summary': "Read 3 documents covering Reed's origin story, dragon form, and relationships."
        }
    """
    import re
...
on the rebound. This is the foundation of Reed's understanding of love - something
