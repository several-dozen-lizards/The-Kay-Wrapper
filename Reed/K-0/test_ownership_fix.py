...
def test_ownership_verification():
    ...
    # Simulate Reed's confused response
    reed_response = "Yeah, my dog Saga is great."

    # Extract facts from Reed's response (this is what encode_memory does)
    extracted_facts = memory._extract_facts(user_input_1, reed_response)
    ...
    reed_response_2 = "Your dog Saga sounds wonderful."
    extracted_facts_2 = memory._extract_facts(user_input_1, reed_response_2)
