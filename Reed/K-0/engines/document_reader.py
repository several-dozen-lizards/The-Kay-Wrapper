...
- Kay needs to read through a document in sections
...
class DocumentReader:
    ...
    Allows Kay to navigate through documents with commands like:
    ...
    def __init__(self, chunk_size: int = 25000):
        ...
        self.total_chunks = 0
        self.chunk_comments = {}  # Store Kay's comments by chunk index
