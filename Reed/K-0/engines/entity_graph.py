...
"""
Entity Resolution and Relationship Graph System for ReedZero
...
class Entity:
    ...
    def add_attribute(self, attribute: str, value: Any, turn: int, source: str = "user"):
        ...
        Args:
            ...
            source: Who stated this ("user" or "kay")
        """
    ...
    def detect_contradictions(self, current_turn: int = 0, resolution_threshold: int = 3, suppress_logging: bool = False) -> List[Dict[str, Any]]:
        ...
        [{
            "attribute": "eye_color",
            "values": [("green", 5, "user"), ("brown", 12, "kay")],
            "severity": "high",
            "resolved": False
        }]
        """
...
class EntityGraph:
    ...
    def _is_valid_entity_name(self, name: str) -> bool:
        ...
        # Reject single characters unless they're letters (like "K" for Reed)
    ...
    def record_visual_entity(
        ...
        Creates a visual_memory entity and connects it to Kay (witnessed),
        Re (shared), and any detected entities (contains).

        This uses behavioral emotional valence, NOT neurochemical values.

        Args:
            description: Description of the visual (what Kay saw)
        ...
        # Track relationships
        # Kay witnessed this visual
        self.add_relationship("Kay", "witnessed", visual_id, turn, "system")
    ...
    def check_ownership_conflict(self, entity: str, claimed_owner: str, identity_memory) -> Dict[str, Any]:
        ...
        Args:
            ...
            claimed_owner: Who is claiming to own it ("Re" or "Kay")
    ...
    def apply_user_correction(
        ...
        When the user corrects Kay about a fact (e.g., "No, those conversations
