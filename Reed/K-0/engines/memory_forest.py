"""
Memory Forest System for Reed
Hierarchical document trees with hot/warm/cold access tiers

Kay reads documents and creates navigable tree structures in his own voice.
...
class MemoryBranch:
    ...
    compressed: str  # Kay's compressed summary in his voice
...
class DocumentTree:
    ...
    doc_id: str
    title: str
    shape_description: str  # Kay's sense of what this document IS
...
class MemoryForest:
    """
    Collection of all document trees - Reed's complete memory forest.
    ...
    def get_forest_overview(self) -> str:
        """
        Reed's view of his memory forest.
    ...
    def navigate_tree(self, doc_id: str, section_id: Optional[str] = None) -> str:
        ...
        Returns Reed's view of the structure.
        """
