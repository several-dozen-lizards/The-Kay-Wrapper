...
FROM KAY'S RESPONSE:
- "your/you" in Reed's response = about Re (USER perspective, NOT Kay)
- "my/I/me" in Reed's response = about Kay ONLY if DIRECT SELF-ASSERTION
...
- Characters/events IN documents are NOT Reed's experiences - they are content Kay READ ABOUT
...
Note: Kay says "Your cats" - this is about Re's cats, NOT Reed's. Do NOT create "Kay owns X".
...
Extract facts now:"""
    ...
    def log_memory_entry(self, conversation_turn: dict, agent_state, memory_stack: list = None) -> Dict[str, Any]:
        ...
        if speaker == "user":
            ...
            # Reed's response - extract from perspective of Kay speaking
            extracted_facts = self._extract_facts_with_entities("", raw_text)
