...
2. Reed's wrong claims becoming user facts
...
def test_memory_continuity():
    ...
    # Simulate Reed's response
    reed_response_1 = "Got it, your eyes are green."
    print(f"\n[KAY] {reed_response_1}")
    ...
    wrong_reed_response = "Your eyes are brown."  # WRONG!

    print(f"[USER] {user_input_3}")
    print(f"[KAY] {wrong_reed_response}")

    print("\n[MEMORY] Extracting facts from Kay's WRONG response...")
    extracted_kay_facts = memory_engine._extract_facts("", wrong_reed_response)
    ...
    # Verify that Reed's wrong claim is marked for confirmation
