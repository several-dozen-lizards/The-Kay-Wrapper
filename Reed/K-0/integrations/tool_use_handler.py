...
class ToolUseHandler:
    ...
    def get_tool_definitions(self, include_web: bool = True, include_curiosity: bool = True, include_documents: bool = True, include_scratchpad: bool = True) -> List[Dict]:
        """
    ...
    def call_with_tools(
        ...
        tools = self.get_tool_definitions(include_web, include_curiosity, include_documents, include_scratchpad)
