"""
Session Loader
Loads previous sessions into current memory context for Reed to review
"""
...
class SessionLoader:
    ...
    Reed's current context for review
    """
    ...
    def load_session_for_review(
        ...
        """
        Convert session into episodic memories for Reed to review
