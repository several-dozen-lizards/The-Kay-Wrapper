...
class DemoApp(tk.Tk):
    ...
    def _build_ui(self, session_count: int):
        ...
        tk.Label(
            footer,
            text="This is a demo. Real integration happens in reed_ui.py",
            font=("Segoe UI", 9),
            bg="#1e1e1e",
            fg="#888888"
    ...
    def _handle_resume(self, session_id: str):
        ...
        messagebox.showinfo(
            "Demo Mode",
            "Resume functionality is available when integrated with reed_ui.py\n\n"
            "It will:\n"
            "• End current session\n"
    ...
    def _handle_load_review(self, session_id: str):
        ...
        messagebox.showinfo(
            "Demo Mode",
            f"Load for Review functionality is available when integrated with reed_ui.py\n\n"
            f"This would load:\n\n"
            f"Session: {title}\n\n"
            f"{summary}\n\n"
...
def main():
    ...
    print("      They work when integrated into reed_ui.py")
    print()
    print("="*60)
    print()
