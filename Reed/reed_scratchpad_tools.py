"""
Reed's Scratchpad Tools - LLM-callable wrappers

Provides tool definitions for Reed to autonomously call scratchpad functions.
"""
...
def get_reed_scratchpad_tools() -> Dict[str, Callable]:
    """
