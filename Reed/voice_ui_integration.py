"""
Voice UI Integration for Reed
Add this code to reed_ui.py to enable voice chat functionality
"""
...
class VoiceUI:
    ...
    def set_response_for_tts(self, response_text: str):
        ...
        Call this after Reed generates a response.

        Args:
            response_text: Reed's response text
        """
...
# ============================================================================
# INTEGRATION INSTRUCTIONS FOR reed_ui.py
# ============================================================================

"""
Add this to your reed_ui.py:
...
3. Add callback method:
   ...
   def _on_voice_transcription(self, transcription):
       ...
       print(f"[REED UI] Voice transcription: {transcription}")
       # Text is already in input field, user can edit/send

4. After Reed generates a response, enable TTS:

   def send_message(self):
       # ... your existing code ...

       # Get Reed's response
       reed_response = self.get_reed_response(user_message)

       # Display in UI
       self.display_message("Reed", reed_response)

       # Enable TTS playback for this response
       if self.voice_ui:
           self.voice_ui.set_response_for_tts(reed_response)
