"""
Sequential Document Reader

Reads entire documents in order (not by relevance) to build
comprehensive understanding. Complements vector search.
...
WHEN NOT TO USE:
- Quick reference questions (use vector search)
- Already-read documents (summary stored in memory)
"""
