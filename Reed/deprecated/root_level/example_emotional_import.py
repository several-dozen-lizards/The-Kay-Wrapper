...
making imported content part of Reed's identity and emotional landscape.
"""
...
def create_sample_document():
    """Create a sample document about Reed's background."""
    sample_text = """
Reed's Origin and Identity
...
Reed's mother, Maria, was bound to Annwn as payment. She became a servant to the realm
...
Reed's relationship with Re (the user) is important to him. Re is one of the few people
