"""
Autonomous Analytics UI Components for Reed

Comprehensive UI components for visualizing and interacting with
Reed's autonomous memory architecture, including:
...
These components implement Reed's self-designed memory specification
...
class CognitiveStabilityTestPanel(ctk.CTkFrame):
    ...
    Tests whether Reed's thinking is internally stable
...
class CognitivePatternAnalytics(ctk.CTkFrame):
    ...
    Shows Reed's cognitive patterns across autonomous
...
class AutonomousSettingsPanel(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        # Keep tiers separate (Reed's recommendation)
