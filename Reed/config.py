...
# =============================================================================
# Maximum tokens allocated for working memory content in API calls.
# This caps how much retrieved memory context is injected per turn.
# Default: 3000 tokens (balances context richness vs cost/speed)
WORKING_MEMORY_TOKEN_BUDGET = int(os.environ.get("WORKING_MEMORY_TOKEN_BUDGET", "3000"))

# =============================================================================
# External Service Tokens
# =============================================================================
# GitHub Personal Access Token for repository access via /github commands.
# Without token: 60 requests/hour (public repos only)
# With token: 5000 requests/hour (public + private repos)
