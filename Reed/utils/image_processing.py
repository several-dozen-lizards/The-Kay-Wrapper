...
"""
Image Processing Utilities for ReedZero
...
def create_visual_memory_entry(
    ...
    Args:
        ...
        reed_description: Reed's description of what she saw
    ...
    memory_entry = {
        'type': 'visual',
        'fact': f"[Visual] {reed_description}",
...
def extract_image_description_prompt(filename: str) -> str:
    """
    Generate a prompt fragment for Reed to describe an image.
