...
try:
    ...
    Observer = None
    FileSystemEventHandler = object  # Dummy base class so definition doesn't crash
...
class MediaWatcher:
    ...
    DEFAULT_WATCH_PATH = r"F:\AlphaKayZero\inputs\media"
    ...
    def scan_existing_files(self) -> list:
        ...
        Useful for startup to process any files added while Kay was offline.
