...
try:
    ...
    client = None
    MODEL = None
    print("[WARNING] LLM client not available - run from Reed root directory")
...
class MemoryExtractor:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return """You are a memory extraction system for Reed, an emotionally-aware AI.
