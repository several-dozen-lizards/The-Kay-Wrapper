"""
Media Experience Orchestrator for Reed
...
Connects to existing Reed systems:
...
class MediaOrchestrator:
    """
    Central coordinator for Reed's media experience system.
    ...
    def __init__(
        ...
        Args:
            emotional_patterns: EmotionalPatternEngine providing Reed's emotional state
        ...
        # Pending experiential response (Reed's listening experience to output)
    ...
    def process_new_audio(self, filepath: str, force_reanalyze: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            # Step 6: Prepare context injection for Reed
    ...
    def generate_listening_response(
        ...
        """
        Generate Reed's CONTEXTUAL experiential response to hearing music.
    ...
    def _generate_contextual_experience(
        ...
        # Self-recognition context (Reed's own work)
        if context.get('kay_created'):
    ...
    def get_and_clear_listening_response(self) -> Optional[str]:
        ...
        This should be called by the UI/main loop to display Reed's
...
if __name__ == "__main__":
    print("MediaOrchestrator test requires full Reed environment")
