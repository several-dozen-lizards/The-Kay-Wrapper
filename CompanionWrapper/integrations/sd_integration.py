...
"""
Stable Diffusion WebUI API Integration for the entityZero
Allows the entity to generate images locally via AUTOMATIC1111's SD WebUI.
...
class StableDiffusionIntegration:
    ...
    # Default generation parameters (the entity's aesthetic)
    DEFAULT_PARAMS = {
        "steps": 20,
        "cfg_scale": 7.0,
        "width": 512,
    ...
    # the entity's style modifiers - added to prompts automatically
    STYLE_PRESETS = {
