...
"""
OpenRouter LLM Backend for the entity Zero Wrapper
...
class OpenRouterBackend:
    ...
    Matches interface of Anthropic/OpenAI clients for the entity's multi-provider system.
    """
    ...
    def __init__(self, api_key: str = None):
        ...
        # the entity's code calls client.messages.create() not client.create()
    ...
    def create(self, 
        ...
        # the entity will still work - he just responds in text instead of calling functions
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/ariluscristatus/CompanionWrapper",
            "X-Title": "the entity Wrapper",
