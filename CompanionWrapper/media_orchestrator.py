"""
Media Experience Orchestrator for the entity Zero
...
class MediaOrchestrator:
    ...
    def update_conversation_context(
        ...
        Args:
            ...
            entities: Active entities in conversation (e.g., ["Re", "[cat]", "Entity"])
    ...
    def generate_listening_response(
        ...
        if context_analysis.get('entity_created'):
            print(f"[CONTEXT CHECK] Entity connection: Created {entity_id}")
    ...
    def _analyze_conversation_context(
        ...
        - entity_created: Whether the entity created this music
