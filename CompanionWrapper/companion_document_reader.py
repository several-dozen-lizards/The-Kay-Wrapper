"""
Document Reading Tools for Companion Wrapper
...
class DocumentReader:
    ...
    def __init__(self, chroma_client: Any = None, collection_name: str = "companion_documents"):
...
def get_document_tools(chroma_client: Any = None) -> Dict[str, callable]:
    """
    Get document reading tools for the tool system
