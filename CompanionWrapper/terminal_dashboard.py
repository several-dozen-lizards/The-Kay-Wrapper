...
Provides a collapsible bottom panel displaying organized log sections for the entity Zero's internal processes.
"""
...
class TerminalDashboard:
    ...
    def _create_log_sections(self):
        ...
        section_names = [
            ...
            "Emotional State",
            "Entity Graph",
            "Identity Tracking",  # the entity's identity vs fictional knowledge
