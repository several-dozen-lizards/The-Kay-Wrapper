...
class EmotionalPatternEngine:
    ...
    # ═══════════════════════════════════════════════════════
    # CURRENT STATE - What the entity is experiencing NOW
    # ═══════════════════════════════════════════════════════
    ...
    def set_current_state(self, emotions, intensity=None, valence=None,
        ...
        """
        Set the entity's current emotional state.
    ...
    # ═══════════════════════════════════════════════════════
    # EXTRACTION - Parse emotions from the entity's responses
    # ═══════════════════════════════════════════════════════

    def extract_from_response(self, response_text):
        """
        Extract emotional indicators from the entity's response text.
    ...
    def build_emotion_context(self):
        """Build emotional context for the entity's prompt"""
        state = self.current_state
