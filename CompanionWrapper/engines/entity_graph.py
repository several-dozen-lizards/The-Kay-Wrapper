...
ENTITY_NOISE_PATTERNS = {
    ...
    # Self-referential system terms (the entity talking about his own systems)
...
class Relationship:
    ...
    Examples: "Re owns [dog]", "the entity lives_in Portland"
    """
...
class EntityGraph:
    ...
    def __init__(self, file_path: str = None):
        if file_path is None:
            ...
            if state_dir:
                file_path = os.path.join(state_dir, "memory", "entity_graph.json")
            else:
    ...
    def check_ownership_conflict(self, entity: str, claimed_owner: str, identity_memory) -> Dict[str, Any]:
        ...
        Args:
            ...
            claimed_owner: Who is claiming to own it ("Re" or "Entity")
