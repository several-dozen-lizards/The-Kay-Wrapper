...
Tracks when the entity is reading through a specific document section by section,
...
class DocumentReadingSession:
    ...
    When active, ONLY the locked document is loaded into the entity's context,
