...
def should_store_claim(
    ...
    Returns:
        ...
        storage_type can be:
            ...
            - "entity_observation" (store as the entity's observation)
            - "blocked" (don't store)
    ...
    # If source is the entity and perspective is the entity, store as normal
    if source_speaker == "entity" and perspective == "entity":
        return (True, "normal")

    # If source is the entity and perspective is user, we need to decide
