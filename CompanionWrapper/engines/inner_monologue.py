"""
Inner Monologue System for the entity Zero
...
XML Structure:
  <inner_monologue>The entity's private thoughts about what's happening</inner_monologue>
  <feeling>Current emotional state and why</feeling>
  <response>What the entity actually says to the user</response>
"""
...
class ParsedResponse:
    """Parsed components of the entity's response with inner monologue."""
    inner_monologue: str = ""
    feeling: str = ""
    spoken_response: str = ""
    raw_response: str = ""
...
class InnerMonologueParser:
    """
    Parses the entity's responses to extract inner monologue, feelings, and spoken response.
    ...
    def parse(self, raw_response: str) -> ParsedResponse:
        """
        Parse the entity's response to extract structured components.
...
def get_inner_monologue_system_prompt_addition() -> str:
    ...
    This should be appended to the entity's existing system prompt.
    """
    return """
...
def get_autonomous_mode_system_prompt_addition() -> str:
    ...
    This enables the entity to process thoughts without direct user input.
    """
    return """
