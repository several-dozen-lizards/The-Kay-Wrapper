"""
Scratchpad Engine - The entity's Quick Note System

Provides the entity with the ability to jot down questions, flags, thoughts,
...
class ScratchpadEngine:
    ...
    def add_item(self, content: str, item_type: str = "note") -> dict:
        ...
        item = {
            ...
            "resolution_note": None,  # the entity's conclusion
    ...
    def get_review_display(self) -> str:
        ...
        Used when the entity wants to review and resolve items. Shows:
        ...
        # Sort by timestamp (oldest first) so the entity sees what's been sitting longest
    ...
    def get_archive_summary(self, limit: int = 20) -> str:
        ...
        This is the entity's record of "questions I've explored and what I learned."
    ...
    def mark_provisional_resolution(self, item_id: int, resolution: str) -> dict:
        ...
        Args:
            item_id: ID of item to resolve
            resolution: the entity's conclusion about this stake
