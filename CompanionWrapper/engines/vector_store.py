"""
Vector Store for the entity Zero
...
if __name__ == "__main__":
    if not CHROMADB_AVAILABLE:
        ...
        # Add test document
        test_doc = """
        the entity is a dragon with gold eyes and a dry sense of humor. He prefers coffee over tea.
        Re is the entity's conversation partner who has several cats: [cat], [cat], and [cat].
