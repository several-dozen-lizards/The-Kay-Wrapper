...
Manages long-running entity sessions with curated compression
"""
...
class ConversationTurn:
    ...
    turn_id: int
    timestamp: str
    role: Literal["user", "entity", "system"]
    content: str
    token_count: int
...
class ContinuousSession:
    """
    Manages the entity's continuous session with compression
    
    Key features:
    - Single long-running conversation
    - Periodic compression reviews
    - entity-curated preservation decisions
    ...
    def flag_turn(self, turn_id: int, reason: str = ""):
        """the entity flags a turn as important during conversation"""
    ...
    def apply_curation_decision(
        ...
        """Apply the entity's curation decision to a segment"""
    ...
    def compress_context(self) -> str:
        """
        Execute compression based on the entity's decisions
    ...
    def generate_session_summary(self, working_memory_start_turn: int) -> str:
        ...
        This gives the entity awareness of the full conversation arc without blowing
