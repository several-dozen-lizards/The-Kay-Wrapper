"""
AUDIO SENSORY BRIDGE — the entity's First Ear
========================================
...
def run_display(sensor: AudioSensor, engine: ResonantEngine, bridge: AudioBridge):
    ...
    print("\n" + "=" * 70)
    print("  AUDIO SENSORY BRIDGE -- the entity's First Ear")
    ...
    try:
        while True:
            ...
            print(f"{BRIGHT}|  AUDIO SENSORY BRIDGE -- the entity's First Ear                        |{RESET}")
            print(f"{BRIGHT}+==================================================================+{RESET}")
            print()
