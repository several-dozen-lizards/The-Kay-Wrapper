...
# Spatial awareness (Phase 2) — supports both the entity's space and Reed's Sanctum
...
def _load_spatial_module(module_name: str = "den") -> bool:
    ...
    Args:
        module_name: "den" for the entity's space, "sanctum" for Reed's Sanctum, "commons" for Nexus
...
class InteroceptionBridge:
    ...
    def __init__(self, memory_layers, engine,
        ...
        Args:
            ...
            presence_type: "den" for the entity's space, "sanctum" for Reed's Sanctum
        """
