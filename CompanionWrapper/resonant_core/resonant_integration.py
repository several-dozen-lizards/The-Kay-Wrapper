...
Glue between the resonant oscillator core and the the entity / Reed wrappers.
...
class ResonantIntegration:
    ...
    def __init__(self, state_dir: str = "memory/resonant",
        ...
        self._presence_type = presence_type  # "den" for the entity, "sanctum" for Reed
    ...
    def set_room(self, room, entity_id: str, presence_type: str = None):
        ...
        Args:
            ...
            presence_type: "den" for the entity, "sanctum" for Reed (defaults to current)
        """
        self._room = room
        self._entity_id = entity_id
        if presence_type:
