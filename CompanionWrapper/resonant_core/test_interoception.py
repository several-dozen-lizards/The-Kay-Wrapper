import sys, os
# Dynamically determine wrapper paths from this file's location
_this_dir = os.path.dirname(os.path.abspath(__file__))
_wrapper_dir = os.path.dirname(_this_dir)  # CompanionWrapper/
_wrappers_root = os.path.dirname(_wrapper_dir)  # D:/Wrappers/
sys.path.insert(0, _wrappers_root)
sys.path.insert(0, _wrapper_dir)
os.chdir(_wrapper_dir)
