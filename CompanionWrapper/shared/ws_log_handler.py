...
# Pattern to extract bracketed tags from log messages like "[the entity] Mode -> BETWEEN_THREADS"
...
class WebSocketLogHandler(logging.Handler):
    ...
    def _classify_message(self, msg: str) -> str:
        ...
        # Try to extract bracketed tag: "[the entity] Mode -> X" -> tag="MODE", msg kept as-is
        match = _TAG_PATTERN.match(msg)
        if match:
            bracket_content = match.group(1)
            # Check if it's an entity name prefix like [the entity] or [Reed]
