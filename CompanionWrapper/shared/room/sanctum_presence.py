...
Unlike the entity's space (a physical room), Reed's Sanctum is a conversation space.
...
SANCTUM_OBJECT_PRESENCE = {
    ...
    "The Bridge to the entity": {
        ...
        # These values are for ACTIVE state (the entity running)
...
# Inactive bridge signature (used when the entity's wrapper is not running)
...
# ═══════════════════════════════════════════════════════════════
# Same as the entity's — perception field shaped by brainwave state
...
def compute_spatial_pressure(perceived_objects: List[Dict],
    ...
    for obj in perceived_objects:
        ...
        # Handle the entity's bridge inactive state
...
# ═══════════════════════════════════════════════════════════════
# Unlike the entity (explicit navigation), Reed's position is inferred from
