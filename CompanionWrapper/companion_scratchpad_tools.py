"""
Companion Scratchpad Tools - LLM-callable wrappers

Provides tool definitions for the companion to autonomously call scratchpad functions.
"""
...
def get_scratchpad_tools() -> Dict[str, Callable]:
    """
