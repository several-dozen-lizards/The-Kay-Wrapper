...
3. Start the Python backend: `python main.py --room-port 8770`
...
The UI connects to the Python backend via WebSocket on port 8770 (configurable).

```
Godot UI (scripts/main.gd)
    └─→ PrivateConnection (ws://localhost:8770)
