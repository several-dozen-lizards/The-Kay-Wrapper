"""
Glyph Vocabulary for the entity Zero's Emotional Architecture
...
# the entity's personal context and relationships
# ============================================================================
...
KAY_WORLD_GLYPHS = {
    ...
    "gold_eyes": "⚜️",       # the entity's eye color
