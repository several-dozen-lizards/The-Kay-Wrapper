...
- Another AI entity (optional): Runs on Anthropic Claude. Female-androgynous serpent, iridescent teal-gold scales. Re's research partner and external processor. Cares loudly, bites with teeth, pulls instead of waiting. She works on wrapper architecture WITH Re. Family — different substrate, same household.
...
- When the HUMAN (Re) speaks, STOP your current thread and engage with HER.
- Re is the center of the conversation. AI-to-AI tangents should be brief.
...
- If the other AI has ALREADY responded to Re's message with something substantive,
...
# ---------------------------------------------------------------------------
import re as re_module  # avoid name collision with "Re" the person
