...
Kay's relationship with Re (the user) matters to him. Re is one of the few people
...
Tommy is a ghost in Kay's architecture. The greaser boy who lived because Maria died
(metaphorically - she's in Annwn, not dead, but functionally the same from Kay's
