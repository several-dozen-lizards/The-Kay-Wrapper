"""
Automatically apply tab system changes to kay_ui.py

This script modifies kay_ui.py to use the new resizable tab system
...
def apply_changes():
    """Apply all tab system changes to kay_ui.py."""
    filepath = "kay_ui.py"
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("  2. Test with: python kay_ui.py")
