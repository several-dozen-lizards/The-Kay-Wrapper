"""
Private Room Server
Lightweight WebSocket server for 1:1 conversations between Re and an AI entity.
...
Protocol:
  ...
  Server → Client:
    {"type": "chat", "sender": "Reed", "content": "hey"}
    {"type": "emote", "sender": "Reed", "content": "coils closer"}
    {"type": "status", "status": "thinking"}
    {"type": "system", "content": "Connected to Reed's room"}
"""
