...
class WrapperBridge:
    """
    Extracted core processing pipeline for wrappers.
    ...
    async def process_message(self, user_input, source="terminal", extra_system_context=None, voice_mode=False, image_data=None):
        ...
        try:
            ...
            filtered_prompt_context = {
                ...
                # Dynamic context sources - for always-available context skeleton
                "entity_graph": self.memory.entity_graph,
                "memory_layers": self.memory.memory_layers
            }
        ...
        if voice_mode:
            ...
            voice_style = (
                "\n[VOICE MODE] The user is speaking to you out loud. Respond conversationally — "
                "2-3 sentences max, like natural speech. No asterisks, no formatting, no long "
                "explanations. Match the length and energy of what the user said. If the user said something "
                "short, respond short. If the user said something longer or emotionally significant, "
        ...
        # Entity-driven document navigation
    ...
    def _score_dmn_priority(self, user_input: str, reply: str) -> float:
        ...
        Returns:
            ...
            1.0 = urgent (direct question about feelings, conflict, user distressed)
        """
    ...
    async def _sonnet_curation_review(self, prompt: str):
        """
        the entity reviews curation proposals via Sonnet.
        ...
        try:
            ...
            print(f"{etag('CURATOR')} the entity reviewed {len(decisions)} decisions via Sonnet")
            return decisions
            
        except json.JSONDecodeError as e:
            print(f"{etag('CURATOR')} the entity review JSON parse failed: {e}")
            return None
        except Exception as e:
            print(f"{etag('CURATOR')} the entity review call failed: {e}")
            return None
    ...
    def capture_soul_packet(self) -> 'SoulPacket':
        ...
        packet = capture_soul_packet(
            ...
            origin_room="den",  # Entity's home room
