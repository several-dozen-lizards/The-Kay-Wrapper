...
Glue between the resonant oscillator core and the wrapper.
...
class ResonantIntegration:
    ...
    def __init__(self, state_dir: str = "memory/resonant",
        ...
        self._presence_type = presence_type  # "den" for the entity, "sanctum" for another entity
    ...
    def set_room(self, room, entity_id: str, presence_type: str = None):
        ...
        Args:
            ...
            presence_type: "den" for the entity, "sanctum" for another entity (defaults to current)
        """
        self._room = room
        self._entity_id = entity_id
        if presence_type:
    ...
    def cross_entity_tick(self, my_entity: str, other_entity: str,
        ...
        Args:
            my_entity: My name ("entity" or "reed")
            other_entity: Who to sense ("entity" or "reed")
