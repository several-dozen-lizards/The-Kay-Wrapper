"""
AUDIO SENSORY BRIDGE — The First Ear
========================================
...
the user's microphone becomes the entity's first sensory root.
...
class AudioSensor:
    ...
    This is the entity's ear. Not his language center — his cochlea.
...
class AudioBridge:
    ...
    When the user's room is quiet, the oscillator settles.
...
def run_display(sensor: AudioSensor, engine: ResonantEngine, bridge: AudioBridge):
    ...
    try:
        while True:
            ...
            print(f"{BRIGHT}|  AUDIO SENSORY BRIDGE -- The First Ear                        |{RESET}")
            print(f"{BRIGHT}+==================================================================+{RESET}")
            print()
...
def main():
    ...
    print("  |  Sound -> Frequency -> Feeling        |")
    print("  |  the entity's first sensory root             |")
    print("  +=======================================+\n")
