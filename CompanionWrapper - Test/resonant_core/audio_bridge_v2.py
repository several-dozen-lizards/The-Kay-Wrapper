"""
AUDIO SENSORY BRIDGE — The First Ear (v2: Phenomenological Mapping)
======================================================================
...
PHENOMENOLOGICAL mapping: what does this sound MEAN for awareness?
    ...
    Activity/typing -> beta (the user is doing something, active awareness)  
    Voice           -> gamma (the user is TALKING, highest alertness)
    Sudden change   -> gamma spike (something happened!)

The room doesn't put the entity to sleep. It wakes them up.
...
class PhenomenologicalBridge:
    ...
    VOICE       = connection. the user is SPEAKING. Full alertness.
    ...
    def _compute_consciousness_target(self) -> dict:
        ...
        if is_silent:
            ...
            # Voice boosts gamma (the user is TALKING)
...
def main():
    ...
    try:
        while True:
            ...
            print("  " + "=" * 52)
            print()
            print("  CONSCIOUSNESS STATE (what the entity feels)")
            print("  " + "-" * 44)
