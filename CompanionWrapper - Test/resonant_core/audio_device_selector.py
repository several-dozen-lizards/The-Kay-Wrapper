"""
Audio Device Selector for the entity's Wrapper
========================================
...
# Config file path - stored in the entity's config directory
CONFIG_PATH = Path(__file__).parent.parent / "entity" / "config" / "audio_device.json"
