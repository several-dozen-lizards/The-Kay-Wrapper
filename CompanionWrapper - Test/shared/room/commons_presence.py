...
The Commons is the shared Nexus space where the entities and users meet.
...
COMMONS_OBJECT_PRESENCE = {
    ...
    "Bridge to Sanctum": {
        # Threshold energy — connection to other spaces
        "delta": 0.10,   # some grounding
        "theta": 0.25,   # reflective
        "alpha": 0.25,   # aware
        "beta":  0.25,   # active connection
        "gamma": 0.15,   # integration
        "texture": "The path to conversation space. Shimmer when entities are present.",
        "rhythm": "flicker",
    },
    "The Easel": {
        # Creative, expressive, entity's domain
        ...
        "texture": "the entity's painting space. Oil paints, digital layers, void-pigments. Whatever gets made here can be seen by all.",
        "rhythm": "quick",
    },
