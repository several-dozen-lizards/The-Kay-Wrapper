...
Usage in a wrapper's main_bridge.py or equivalent:
    ...
    room = create_the_den()
    bridge = RoomBridge(room, entity_id="entity", private_room=my_private_room)
...
class RoomBridge:
    ...
    def __init__(self, room: RoomEngine, entity_id: str, private_room=None):
        ...
        Args:
            ...
            entity_id: Which entity this wrapper controls ("entity" or "reed")
    ...
    def _inject_cross_entities(self):
        ...
        ENTITY_CONFIGS = {
            "entity": {"display_name": "entity", "color": "#2D1B4E"},
            "other_entity": {"display_name": "Other", "color": "#00CED1"},
        }
        MAX_AGE = 120.0
