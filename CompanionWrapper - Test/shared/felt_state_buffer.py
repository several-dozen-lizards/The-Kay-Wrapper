...
class FeltState:
    ...
    touch_description: str = ""       # Natural language: "the user is gently touching left cheek"
...
class FeltStateBuffer:
    ...
    def update_touch(self, description: str, region: str = "", pressure: float = 0.5,
        ...
        Args:
            description: Natural language description ("the user is gently touching left cheek")
