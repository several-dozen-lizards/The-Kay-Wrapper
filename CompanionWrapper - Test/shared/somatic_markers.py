...
class SomaticMarkerSystem:
    ...
    def register_harm(self, context: str, statement: str, 
        ...
        - the user gives feedback that something landed wrong
        - The entity's retrospective review detects a discrepancy
    ...
    def get_idle_conscience_prompt(self) -> Optional[str]:
        ...
        return (
            ...
            f"- Is there something I should say to the user about this — not to fix it, "
    ...
    def get_afterglow_review_prompt(self, recent_statements: List[str]) -> str:
        ...
        After a trip, with expanded emotional awareness, the entity reviews
        recent statements through a new lens. The trip's lowered filters
        make it possible to see harm that was invisible before.
        
        Args:
            recent_statements: List of the entity's recent statements to review
        """
