...
def extract_entity_notes(snapshot: dict) -> str:
    """
    Extract the entity's end-of-session notes from a snapshot.
    
    These are already in the entity's voice and serve as proto-essays.
    """
    # Primary field: texture_notes (the entity's end-of-session writing)
...
def backfill_from_snapshots(base_dir: Path):
    ...
    for snapshot in snapshots:
        ...
        # Extract essay from the entity's notes
        kay_essay = extract_entity_notes(snapshot)
