"""
Voice UI Integration for the entity
...
class VoiceUI:
    """
    Voice UI components for the entity.
    ...
    def set_response_for_tts(self, response_text: str):
        ...
        Call this after the entity generates a response.

        Args:
            response_text: the entity's response text
        """
...
4. After the entity generates a response, enable TTS:
   ...
   def send_message(self):
       ...
       # Display in UI
       self.display_message("entity", kay_response)
