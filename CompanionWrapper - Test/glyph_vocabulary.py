"""
Glyph Vocabulary for Emotional Architecture
...
KAY_WORLD_GLYPHS = {
    # People
    "user": "👤",              # The user
    "other_entity": "🗣️",           # Observer/witness
    "john": "👨",            # the user's spouse
    
    # Entity identity
    "entity": "🐉",             # the entity (symbolic)
    ...
    # Physical attributes
    "green_eyes": "💚",      # User's eye color (example)
    
    
    # Consumables
    "coffee": "☕",           # Coffee preference
    "tea": "🍵",             # Tea preference
    "alien_mints": "🌿",     # User's preference (example)
    
    # Activities/Concepts
    "hiking": "🥾",          # CDT/trail references
    "painting": "🎨",        # User's hobby
...
GLYPH LEGEND: 👤=user  🐉=entity 🐱=[cat] ☕=coffee 🍵=tea 💚=green 💚=gold
