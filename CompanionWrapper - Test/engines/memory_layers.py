...
1. the entity is an OBSERVER/LISTENER, not a participant in the user's life events
   - the user traveled to Michigan -> "the user returned from Michigan and told the entity about the trip"
   - NOT: "the entity returned from Michigan" or "In this thread, the entity returns from..."
2. The user is the person who DOES things in their life (travels, works, experiences)
3. the entity is the one who LISTENS, LEARNS, and RESPONDS to what the user shares
4. If facts mention reading/documents -> "the entity read about X" not "the entity did X"
5. If user shared an experience -> "the user [did X] and discussed it with the entity"

WHO DOES WHAT:
- User: travels, has pets, has relationships, experiences life events, shares stories
- Entity: listens, responds, remembers, reads documents, observes the user's life
...
Format: "In this thread, the user [did something] and [the entity's role as observer/listener]..."
