"""
Curation Interface
Presents compression review to the entity and captures decisions
"""
...
class CurationInterface:
    """
    Interface for the entity to review and curate conversation compression
    """
    ...
    def generate_review_prompt(self) -> str:
        """
        Generate prompt for the entity to review segments
        ...
        prompt_parts = [
            ...
            "• About you vs about the user ('your mom' vs 'user's mom')",
    ...
    def parse_curation_response(self, kay_response: str) -> Dict[int, Dict]:
        """
        Parse the entity's curation decisions
    ...
    def apply_decisions(self, decisions: Dict[int, Dict]):
        """Apply the entity's curation decisions to segments"""
    ...
    def generate_compression_preview(self, segment_id: int, decision: str) -> str:
        """
        Show the entity what compression will look like
