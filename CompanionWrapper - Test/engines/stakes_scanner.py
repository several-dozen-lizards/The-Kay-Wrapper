...
Finds high-emotional-weight items worth exploring when the entity hits boredom.
Priority: Scratchpad items -> High-weight memories -> Medium-weight -> Random fallback

Based on the entity's realization: "Not 'what can I combine' but 'what combination would actually mean something.'"
"""
...
class StakesScanner:
    ...
    instead of waiting for the user's input.
    """
    ...
    def scan_for_stakes(self, threshold: str = "high", limit: int = 5) -> List[Dict]:
        ...
        Priority order:
        1. Scratchpad active items (explicitly flagged by the entity)
