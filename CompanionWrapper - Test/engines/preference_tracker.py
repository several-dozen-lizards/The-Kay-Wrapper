...
class PreferenceTracker:
    """
    Tracks the entity's preferences and attributes to maintain identity coherence.
    ...
    - the entity can express: "I'm mostly a tea person, but I enjoy coffee too"
    """
    ...
    def track_preference(self, text: str, perspective: str, context: Optional[str] = None):
        ...
        Only tracks the entity's preferences (perspective="entity").
        """
        if perspective != "entity":
            return  # Only track the entity's preferences
    ...
    def get_preference_summary(self, domain: Optional[str] = None) -> str:
        """
        Generate human-readable summary of the entity's preferences.
