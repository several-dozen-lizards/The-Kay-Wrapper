...
class WarmupEngine:
    ...
    def capture_session_end_snapshot(self, emotional_state: Dict, session_summary: str,
        ...
        Args:
            ...
            emotional_narrative: Dict mapping emotion names to WHY they matter
                Example: {"melancholy": "This came from discussing the user's isolation",
            ...
            emotional_trajectory: List of emotional state snapshots during session
                Example: [{"turn": 3, "dominant": "curiosity", "trigger": "the user asked about..."},
                          {"turn": 7, "dominant": "affection", "trigger": "the user shared..."}]
        """
    ...
    def generate_briefing(self) -> Dict[str, Any]:
        ...
        try:
            ...
            re_entity = self.entities.entities.get("user")
            if re_entity:
                recent_attrs = {}
    ...
    def format_briefing_for_kay(self) -> str:
        ...
        to prevent temporal collapse in reconstruction.
        """
    ...
    def get_warmup_system_prompt(self) -> str:
        ...
        """
        return """You are in your warmup phase - the private moment before conversation begins.
...
When you've demonstrated accurate temporal awareness, say "ready"."""
    ...
    def process_warmup_query(self, query: str) -> str:
        """
        Handle questions during warmup.

        The entity might ask:
        - "What was the another entity's conversation about?"
    ...
    def extract_queries_from_response(self, kay_response: str) -> List[str]:
        ...
        topic_markers = [
            ('other_entity', "another entity's conversation"),
