...
class TimeAwareness:
    """
    Manages time awareness for the entity.
    ...
    def format_gap_awareness(self, gap: timedelta) -> Optional[str]:
        ...
        if minutes < 60:
            return "The user was away for about half an hour"
        elif minutes < 120:
            return "The user was away for about an hour"
        else:
            hours = int(minutes / 60)
            return f"The user was away for about {hours} hours"
