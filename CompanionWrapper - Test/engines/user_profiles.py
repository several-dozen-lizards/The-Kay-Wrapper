"""
User Profile System for the entity
...
class ProfileManager:
    ...
    def _create_default_profiles(self):
        ...
        self.create_profile("reed", {
            "name": "another_entity",
            "canonical_name": "another_entity",
            "aliases": ["reed"],
            "entity_type": "ai_sibling",
            "first_person_entity": "another_entity",
    ...
    def get_active_profile(self) -> Optional[UserProfile]:
        ...
        # Default to user if no profile set
