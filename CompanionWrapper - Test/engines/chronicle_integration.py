"""
Chronicle Integration for the entity's Warmup

Adds the entity's session chronicle essay to warmup briefing.
"""
...
class ChronicleIntegration:
    """Handles loading and formatting the entity's chronicle for warmup."""
    ...
    def get_last_session_essay(self) -> Optional[Dict]:
        ...
        return {
            ...
            "kay_essay": most_recent.get("kay_essay", ""),
    ...
    def format_chronicle_section(self, current_session_order: int) -> str:
        ...
        Args:
            current_session_order: The session number the entity is waking up to
        ...
        lines = []
        lines.append("=" * 60)
        lines.append("LAST SESSION - The entity's Chronicle")
        lines.append("=" * 60)
        ...
        lines.append("")
        lines.append("--- What the entity Wrote for next-self ---")
        lines.append("")
        
        # the entity's essay (the main content)
        essay = last_session["kay_essay"]
        lines.append(essay)
...
def add_chronicle_to_briefing(warmup_engine, briefing_text: str) -> str:
    """
    Add chronicle essay to the beginning of the entity's warmup briefing.
