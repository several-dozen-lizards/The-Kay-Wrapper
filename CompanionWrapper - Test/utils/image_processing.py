...
"""
Image Processing Utilities for the entityZero
...
def create_visual_memory_entry(
    ...
    Args:
        ...
        entity_description: The entity's description of what he saw
...
def extract_image_description_prompt(filename: str) -> str:
    """
    Generate a prompt fragment for the entity to describe an image.

    This helps the entity engage with visual input meaningfully.
    """
    return f"""
The user has shared an image with you: {filename}
...
3. Consider what it means that the user chose to share this with you
