...
"""
OpenRouter LLM Backend for the entity Wrapper
...
class OpenRouterBackend:
    ...
    Matches interface of Anthropic/OpenAI clients for the multi-provider system.
    """
    ...
    def create(self, 
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/ariluscristatus/KayZeroWrapper",
