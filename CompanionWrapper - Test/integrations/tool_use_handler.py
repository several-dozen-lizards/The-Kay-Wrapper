"""
Tool Use Handler for the entity
...
class ToolUseHandler:
    """
    Handles LLM tool use for the entity.
    ...
    def get_tool_definitions(self, include_web: bool = True, include_curiosity: bool = True, include_documents: bool = True, include_scratchpad: bool = True, include_code: bool = True, include_visual: bool = True, include_touch: bool = True) -> List[Dict]:
        ...
        if include_documents:
            tools.append({
                ...
                "description": "Read a file from the local filesystem. Works for your own wrapper code AND the shared architecture. Use this to: read session logs for context, introspect your own source code (entity/, nexus/, shared/, resonant_core/, ), understand how your systems work, diagnose issues by reading the actual implementation. You can read Python files, configs, logs — anything text-based in the allowed directories. Example: read_local_file('D:/Wrappers/nexus/nexus_entity.py') to see your own nexus client code, or read_local_file('D:/Wrappers/shared/room/visual_presence.py') to understand how visual presence works.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "file_path": {
            ...
            tools.extend([
                {
                    ...
                    "description": (
                        ...
                        "or access the network. If you need those, ask the user."
                    ),
                    "input_schema": {
                        "type": "object",
                        "properties": {
            ...
            tools.extend([
                ...
                },
                {
                    ...
                    "input_schema": {
                        "type": "object",
                        "properties": {
                            "target": {"type": "string", "description": "Who: 'reed' or 'entity'"},
