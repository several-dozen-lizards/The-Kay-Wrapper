...
const VOICE_SERVER_URL := "http://localhost:8780"  # Companion room port
...
func _build_ui() -> void:
	...
	_server_url_input = _add_text_field("API Endpoint:", "http://localhost:8780")
	_room_port_input = _add_text_field("Room Port:", "8780")
