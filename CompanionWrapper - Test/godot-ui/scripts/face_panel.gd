...
var API_BASE: String = "http://localhost:8785"
...
var _server_url: String = "http://localhost:8785"
...
func _toolbar_click(_pos: Vector2) -> bool:
	return false  # Toolbar disabled
...
func _draw_toolbar() -> void:
	pass  # Toolbar disabled for companion UI


func _get_object_color(_obj_name: String) -> Color:
	return Color.WHITE
