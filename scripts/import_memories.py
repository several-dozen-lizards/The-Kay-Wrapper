#!/usr/bin/env python
"""
CLI Memory Import Tool for Kay Zero
Imports archived documents into Kay's persistent memory
...
async def import_memories(args):
    ...
    print("=" * 70)
    print("KAY ZERO MEMORY IMPORT")
    print("=" * 70)

    # Initialize memory system
    print("\n[INIT] Loading Kay's memory system...")
    try:
        state = AgentState()
...
def main():
    parser = argparse.ArgumentParser(
        description="Import archived documents into Kay Zero's memory system",
