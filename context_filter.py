...
class GlyphFilter:
    """
    Filters Kay's complete agent state and outputs compressed glyph representations.
    ...
    def __init__(self, filter_model=None):
        ...
        if filter_model is None:
            ...
            filter_model = os.getenv("FILTER_MODEL", "claude-3-5-haiku-20241022")
    ...
    def _build_system_prompt(self) -> str:
        ...
        return f"""You are a context filter for Kay Zero, an emotionally-aware AI with persistent memory.

Your job: Analyze Kay's full state and compress it into symbolic glyphs for efficient communication.

MEMORY STORAGE MODEL:
Kay's memories are stored in two types:
...
OUTPUT GLYPHS:"""
    ...
    def _detect_contradictions(self, memories: List[Dict]) -> str:
        """
        Detect contradictory statements in Kay's memories.
