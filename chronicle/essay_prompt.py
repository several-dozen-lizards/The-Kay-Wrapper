...
Prompts Kay to write an essay at session end about what mattered.
...
class SessionEssayPrompt:
    """
    Generates the end-of-session prompt for Kay to write his essay.
    """
    ...
    def generate_essay_prompt(
        ...
        """
        Generate the prompt asking Kay to write his end-of-session essay.
        
        This is what Kay sees when the session is ending.
        ...
        lines.append("This is the main thing next-Kay will see when they wake up.\n")
        ...
        lines.append("Don't just list facts - Re already has those.")
    ...
    def extract_essay_metadata(self, essay_text: str) -> Dict:
        """
        Attempt to extract structured metadata from Kay's essay.
    ...
    def save_essay_to_chronicle(
        ...
        """
        Save Kay's essay to the chronicle.
        
        Args:
            session_order: Current session number
            session_id: Current session ID
            session_start_time: When session started
            essay_text: Kay's essay
