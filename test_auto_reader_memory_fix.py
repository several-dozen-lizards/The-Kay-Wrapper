...
def test_memory_fixes():
    ...
    Second segment continues the narrative. Kay's previous response to segment 1
    should now be in his recent memory. This creates continuity across segments
    and prevents computational drift.

    Third segment wraps up. All of Kay's responses should be stored properly,
    ...
    def mock_llm_wrapper(prompt, agent_state):
        """
        Mock LLM wrapper that simulates the actual wrapper in main.py/kay_ui.py.
